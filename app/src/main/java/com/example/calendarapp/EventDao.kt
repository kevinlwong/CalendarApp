...
interface EventDao {
    ...
    @Query("UPDATE events SET title = :title, description = :description, timestamp = :timestamp, timeInMillis = :timeInMillis WHERE id = :id")
    suspend fun updateEvent(id: Long, title: String, description: String?, timestamp: Long, timeInMillis: Long)
